        ...
        <div class="col-xs-12 col-sm-3">
         ...
         <div class="col-xs-12 col-sm-3">
                                       <div class="form-group input-group">
                                        ...
                                        <div class="col-xs-12 col-sm-3">
                                            <div class="form-group input-group">
                                            <span class="input-group-addon">ใบเสนอราคา</span>
                                            <input type="text" class="form-control" class="quotation" placeholder="คลิกเพื่อดาวน์โหลด">
                                        </div>
                                        </div>
